...
dynamic initSocketManager(BuildContext context) {
  ...
  _socketInstance = io.io(
    "${ApiConstants.socketUrl}chat?id=${ApiConstants.chatUserId}",
    <String, dynamic>{
...
void handleOnCallRequest(dynamic response) {
  if (response != null) {
    ...
    print(' Call handleOnCallRequest data=${data}');
...
void handleOnAcceptCall(dynamic response) async {
  if (response != null) {
    ...
    print(' Call handleOnAcceptCall data=${data}');
...
void handleOnRejectCall(dynamic response) {
  print(' Call handleOnRejectCall response=${response}');
