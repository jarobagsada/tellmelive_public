...
import '../../../utilmethod/showtoast_widgets.dart';
import '../../holder/call_model.dart';
import '../call/call_cubit.dart';
import '../call/call_state.dart';
import '../call_widgets/default_circle_image.dart';
import '../call_widgets/user_info_header.dart';
import 'package:permission_handler/permission_handler.dart';

class CallScreen extends StatefulWidget {
  final bool isReceiver;
  final CallModel callModel;
  const CallScreen({Key key,  this.isReceiver,  this.callModel}) : super(key: key);
...
class _CallScreenState extends State<CallScreen> {
   ...
   bool checkPlatformOS=false;

  @override
  void initState() {
    super.initState();
    checkPlatformSystemOS();
  ...
  Future<void> checkPlatformSystemOS()async {
    if(Platform.isIOS){
      checkPlatformOS=true;
    }else{
      checkPlatformOS=false;
    }
  }
  ...
  Future<void> rePermission() async {
   ...
   (await PermissionHandler() .requestPermissions([PermissionGroup.camera]))[PermissionGroup.camera];
    ...
    (await PermissionHandler() .requestPermissions([PermissionGroup.microphone]))[PermissionGroup.microphone];
  }
  @override
          ...
          child: WillPopScope(
            ...
            child: Scaffold(
              body: Stack(
                ...
                children: [
                  cubit.remoteUid == null ? !widget.isReceiver ? Container(color: Colors.red,child:checkPlatformOS==true?RtcLocalView.TextureView():RtcLocalView.SurfaceView()) : Container( //res
                       ...
                       Align(
                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                            ...
                            checkPlatformOS==true?RtcLocalView.TextureView():RtcLocalView.SurfaceView()
                          ),
                        ),
                      ),
                    ],
  ...
  Widget _remoteVideo({ int remoteUserId}) {
    return //RtcRemoteView.SurfaceView(uid: remoteUserId,channelId: /*widget.callModel.channelName!*/ agoraTestChannelName,);
    Platform.isIOS?RtcRemoteView.TextureView(uid: remoteUserId,channelId: /*widget.callModel.channelName!*/ agoraTestChannelName,):RtcRemoteView.SurfaceView(uid: remoteUserId,channelId: /*widget.callModel.channelName!*/ agoraTestChannelName);
  }
}
