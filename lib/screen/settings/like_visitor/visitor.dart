...
class Visitior_Screen extends StatefulWidget {
  @override
  _Visitior_ScreenState createState() => _Visitior_ScreenState();
}

class _Visitior_ScreenState extends State<Visitior_Screen> {
  ...
  get _appbar {
    return PreferredSize(
      ...
      child: AppBar(
        title: CustomWigdet.TextView(
            text: AppLocalizations.of(context).translate("visitors").toUpperCase(),
            textAlign: TextAlign.center,
  ...
  Future<List<User>> _ItemList() async {
    try {
      ...
      String url = WebServices.GetVisitor +
