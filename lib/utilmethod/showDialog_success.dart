...
class ShowDialogSuccess{

  static   Future<bool> showDialogSuccessMessage(BuildContext context,var Title,var MSG,var status,var Type_Action,var MQ_Width,var MQ_Height) async {
                ...
                Container(
                  ...
                  child: FlatButton(
                    onPressed: ()async{
                      ...
                      if(Type_Action=='CreateActivity'){
                        Navigator.of(context).pushNamedAndRemoveUntil(
                            Constant.ActivitySetting,
                            ModalRoute.withName(Constant.NavigationRoute),
